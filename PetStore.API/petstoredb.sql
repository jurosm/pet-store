...
-- Started on 2020-01-31 11:12:38
...
2020-01-31	30	Zoran	Markovic	Bih,Banja Luka,Cara Lazara 5	BA,Prnjavor	succeeded	ch_1G6wQmLOGOt5JdU3zZh8ANKN
2020-01-31	31	Milos	Anicic	Srbija,Beograd,Akademska 5	BA,Prnjavor	succeeded	ch_1G6wS3LOGOt5JdU3btrKeBrq
2020-01-31	32	Petar	Jokic	Srbija,Beograd,Admirala Geprata 24	BA,Prnjavor	succeeded	ch_1G6wTZLOGOt5JdU354Bi88gE
...
SELECT pg_catalog.setval('petstore."OrderItem_OrderItemId_seq"', 38, true);
...
SELECT pg_catalog.setval('petstore."Order_OrderId_seq"', 32, true);
...
-- Completed on 2020-01-31 11:12:38
